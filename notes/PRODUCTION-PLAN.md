...
- [x] **Baker's death:** the scene is already written (Palm grapples him, Wozzy in the mix) — you're adding the *why*. John unknowingly frees the brain → that snaps Baker lucid for the first time → lucid Baker blows himself up *trying to stop it*. Motive stays hidden: reads as absurdist "of course he blows it all up," but it's his one clear-headed act. (Matches the note "Baker blowing it up is his last attempt to stop.")
...
- [ ] **Baker's death** — the fight (Palm, Wozzy) is already on the page; layer in the *why*: John's release of the brain snaps Baker lucid, and he blows himself up trying to stop it (reads as a gag, motive hidden).
